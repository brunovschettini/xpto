...
public class Data {
     ...
     *
     * @param date
     * @param format (Formato que a (Date) data deverá retornar - yyyy-MM-dd
     * HH:mm:ss - Ex. Entra 2013-01-01 - livre(date, 'dd/MM/yyyy'))
     * @return '01/01/2013'
     */
    ...
    public static String converteDataHifen(Date data) {
        if (data != null) {
            String a = data.toString();
    ...
    public static String dateToDatetimeLocal(Date data) {
        if (data != null) {
            String b = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm").format(data);
            // String b = dateFormat.format(data);
            return b;
        } else {
            return "";
     ...
     * @return
     */
    public static Date datetimeLocalToDate(String data) {
        if (data != null) {
            try {
                try {
                    DateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
    ...
    public static Date converteUS(String data) {
        if (data != null) {
            try {
