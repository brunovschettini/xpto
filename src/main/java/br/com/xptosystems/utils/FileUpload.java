...
public class FileUpload {
    ...
    public static void upload(String path, String filename, Part fileUpload) throws IOException {
        ...
        String resources = ((ServletContext) FacesContext.getCurrentInstance().getExternalContext().getContext()).getRealPath("") + File.separator + "resources" + File.separator + "clients" + File.separator + "xptosystems" + File.separator + path;
